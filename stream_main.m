% Vehicle path planning using stream function for avoiding stationary obstacles
% using Circle Theorem as described in the below reference.
...
% create stream function with stationary obstacle
[U, V, psi] = stream_stationary_obstacle(bx, by, a);
